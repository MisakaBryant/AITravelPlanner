...
// 复用 OpenAI client 和 callLLM：ai 路由默认导出 router，并在其对象上挂载 callLLM
const aiRouter = require('./ai');
const callLLM = aiRouter.callLLM;
